...
class DataValidation:
    ...
    def validate_number_of_columns(self,dataframe:pd.DataFrame)->bool:
        try:
            ...
            logging.info(f"Data frame of columns:{len(dataframe.columns)}")
    ...
    def numberical_columns_exits(self,dataframe:pd.DataFrame)->bool:
        try:
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            ## Is numberical columns exits
            status=self.numberical_columns_exits(dataframe=train_dataframe)
            if not status:
                error_message=f"Train dataframe does not contain numerical columns. \n"
            status=self.numberical_columns_exits(dataframe=test_dataframe)
            if not status:
